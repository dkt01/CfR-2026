...
namespace cfr_arduino_bridge
{
  ...
  namespace
  {
    ...
    SegmentCommand ComputeStraight(const Segment &segment, const Pose2D &start, const Pose2D &current,
    ...
    SegmentCommand ComputeTurn(const Segment &segment, const Pose2D &start, const Pose2D &current,
                               const ControllerParams &p)
    {
      SegmentCommand cmd;
